...
class CustomResponseCode(CustomCodeBase):
    ...
    HTTP_500 = (500, '服务器内部错误')
     ...
     # 认证 (100xx)
    LOGIN_SUCCESS = 10000
    LOGOUT_SUCCESS = 10001
    REGISTER_SUCCESS = 10002
    TOKEN_INVALID = 10010
    TOKEN_EXPIRED = 10011
    INVALID_CREDENTIALS = 10020
    USER_LOCKED = 10021

    # 用户 (101xx)
    USER_NOT_FOUND = 10100
    USER_EXISTS = 10101
    PASSWORD_ERROR = 10102
    OLD_PASSWORD_ERROR = 10103
    PROFILE_UPDATE_SUCCESS = 10104
    PASSWORD_CHANGE_SUCCESS = 10105
    PASSWORD_NOT_SET = 10106
    ACCOUNT_DISABLED = 10107

    # SMS (102xx)
    SMS_CODE_ERROR = 10200
    SMS_CODE_EXPIRED = 10201
    SMS_CODE_NOT_SENT = 10202
    SMS_CODE_SEND_FAILED = 10203
    SMS_CODE_SEND_TOO_FREQUENTLY = 10204
